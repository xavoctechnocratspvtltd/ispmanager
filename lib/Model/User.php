	...
	function page_CurrentConditions($page){
		...
		if($crud->isEditing()){
			...
			$form->add('xepan\base\Controller_FLC')
				...
				->layout([
						'plan_id'=>'About Plan~c1~4',
						'remark'=>'c11~8',
						'condition_id'=>'c2~12',
						'is_topup'=>'Topup~c1~4',
						'data_limit'=>'c2~4',
						'carry_data'=>'c3~4',
						'download_limit'=>'DL/UL Limit~c1~4~in KBps',
						'upload_limit'=>'c11~8~in KBps',
						'fup_download_limit'=>'c2~4~in KBps',
						'fup_upload_limit'=>'c21~8~in KBps',
						'accounting_download_ratio'=>'Accounting~c1~4~in %',
						'accounting_upload_ratio'=>'c2~8~in %',
						'start_date'=>'Dates~c1~4',
						'end_date'=>'c11~4',
						'expire_date'=>'c12~4',
						'is_expired'=>'c2~4',
						'is_recurring'=>'c21~4',
						'is_effective'=>'c22~4',
						'download_data_consumed'=>'Data Consumed~c1~4~in MB',
						'upload_data_consumed'=>'c2~8~in MB',
						'time_limit'=>'Time Limit~c1~4',
						'data_limit_row'=>'c11~8',
						'duplicated_from_record_id'=>'c2~4',
						'is_data_carry_forward'=>'c21~8',
						'start_time'=>'Time~c1~4',
						'end_time'=>'c2~8',
						'reset_date'=>'Reset Box~c1~4',
						'data_reset_value'=>'c2~4',
						'data_reset_mode'=>'c3~4',
						'sun'=>'Week~c1~1',
						'mon'=>'c2~1',
						'tue'=>'c3~1',
						'wed'=>'c4~1',
						...
						'd30'=>'c30~1',
						'd31'=>'c31~1',
						'treat_fup_as_dl_for_last_limit_row'=>'MISC~c1~4',
						'is_pro_data_affected'=>'c2~8',
						'burst_dl_limit'=>'Burst~c1~4~limit per second',
						'burst_ul_limit'=>'c11~4~limit per second',
						'burst_threshold_dl_limit'=>'c12~4~limit per second',
						'burst_threshold_ul_limit'=>'c2~4~limit per second',
						'burst_dl_time'=>'c21~4~time in second',
						'burst_ul_time'=>'c22~4~time in second',
						'priority'=>'c3~12',
				]);
