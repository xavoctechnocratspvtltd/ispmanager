...
class page_lead_installed extends \xepan\base\Page{
	...
	function init(){
		...
		$crud = $this->add('xepan\hr\CRUD',['allow_add'=>false,'status_color'=>['Installed'=>'btn btn-warning']]);
		$crud->setModel($model,['name','plan','organization','installation_assign_at','installation_assign_to','installed_at','installed_narration','shipping_address','shipping_city','shipping_state','remark','created_at','contacts_str','emails_str','status','created_by']);
