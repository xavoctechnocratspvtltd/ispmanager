...
class page_tests_001PlanSetToUserTest extends page_Tester {
    ...
    function prepare_setplan1(){
        $this->proper_responses['test_setplan1']=[
            [   
                'user'=>'Test User',
                'plan'=>'PL-50-M',
                'data_limit'=>'50.00GB',
                ...
                'upload_limit'=>'1.00MB',
                'fup_download_limit'=>'0.00B',
                'fup_upload_limit'=>'0.00B',
        ...
        return [array_keys($this->proper_responses['test_setplan1'][0])];
    }
